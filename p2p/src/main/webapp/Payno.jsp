        ...
        <div class="quick-pay-wrap">
          ...
          <div class="pay-tipcon2"> <b>温馨提示：</b><br>
            ...
            <div class="alert-450 alert-h220" id="alert-rechargeFailture" style="display:none;">
            	<div class="alert-title"><h3>登录网上银行充值</h3><span class="alert-close" onclick="displaySpan('alert-rechargeFailture')"></span></div>
            	<div class="alert-main">
            		<form id="rechargeFailtureForm">
		        		<p class="msg1"><i class="no-icon"></i><i class="msgtxt">充值失败</i>您可以：<a href="/user/recharge"><font color="#28A7E1">选择其他银行充值</font></a>或查看<a href="/term/Commonproblem?CategoryTermId=guanyutixian"><font color="#28A7E1">充值帮助</font></a></p>
		        	</form>
            	</div>
            </div>
            ...
            $(
            	function()
            	{
            		...
            		{
            			showSpan('alert-rechargeFailture');
            		}
            	}
             )
			...
			<div class="alert-450" id="alert-tyht" style="display:none;">
				<div class="alert-title"><h3>提示信息</h3><span class="alert-close" onclick="displaySpan('alert-tyht')"></span></div>
				<div class="alert-main" style="margin-bottom: 35px;margin-left: 25px;">
			    	<p class="msg4">
			    	        你需要阅读并同意《亿人宝金融投资咨询与管理服务电子协议》
			    	</p>
			    </div>
			</div>
        </div>
